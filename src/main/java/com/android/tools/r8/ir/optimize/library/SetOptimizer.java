...
public class SetOptimizer extends StatelessLibraryMethodModelCollection {
  private final DexItemFactory dexItemFactory;
  private final JavaUtilCollectionsMembers collectionsMembers;
  private final DexMethod of0;

  SetOptimizer(AppView<?> appView) {
    this.dexItemFactory = appView.dexItemFactory();
    collectionsMembers = dexItemFactory.javaUtilCollectionsMembers;
    of0 = dexItemFactory.javaUtilSetMembers.of0;
  }

  @Override
  public DexType getType() {
    return dexItemFactory.javaUtilSetType;
  }
  ...
  public InstructionListIterator optimize(
    ...
    // Convert List.of() -> Collections.EMPTY_SET to save on the move-return-value opcode.
    if (singleTargetReference.isIdenticalTo(of0)) {
      ...
      if (outType == null) {
        ...
        instructionIterator.replaceCurrentInstruction(
            new StaticGet(code.createValue(outType), collectionsMembers.EMPTY_SET));
      }
    }
